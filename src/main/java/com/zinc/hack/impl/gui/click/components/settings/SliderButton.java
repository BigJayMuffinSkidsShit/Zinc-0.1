...
public class SliderButton extends Component {
    ...
    public void render() {
        ...
        Zinc.gui.drawGradient(button.frame.getX(), button.frame.getY() + offset, (int) (button.frame.getX() + renderWidth), button.frame.getY() + offset + 16, isHovered ? ClickGui.color.darker().getRGB() : ClickGui.color.getRGB(), isHovered ? ClickGui.color.darker().getRGB() : ClickGui.color.getRGB());
        FontUtil.drawCFontText(setting.getName(),  button.frame.getX() + 5, button.frame.getY() + offset + 1, isHovered ? new Color(170, 170, 170).getRGB() : -1);
        FontUtil.drawCFontText(String.valueOf(round(setting.getValue(), setting.getDecimal())), button.frame.getX() + button.frame.getWidth() - 2 - FontUtil.getCFontTextWidth(String.valueOf(round(setting.getValue(), setting.getDecimal()))), button.frame.getY() + offset + 1, isHovered ? new Color(170, 170, 170).getRGB() : -1);
    }
