...
import com.zinc.hack.impl.modules.render.CustomFOV;
...
public class RotationUtil
    ...
    public static boolean isInFov(final Vec3d vec3d, final Vec3d other) {
        ...
        final float fov = (float) ((CustomFOV.getINSTANCE().isEnabled() ? CustomFOV.getINSTANCE().amount.getValue() : RotationUtil.mc.gameSettings.fovSetting) / 2.0f);
