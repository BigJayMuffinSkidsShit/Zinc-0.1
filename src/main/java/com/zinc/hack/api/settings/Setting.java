package com.zinc.hack.api.settings;
...
public class Setting<T> {
    ...
    public Setting(final String name, final Module module, final Module.Category category, T value, float min, float max) {
        this.name = name;
        this.module = module;
        this.category = category;
        this.value = value;
    ...
    public Setting(final String name, final Module module, final Module.Category category, T value, int min, int max) {
        this.name = name;
        this.module = module;
        this.category = category;
        this.value = value;
    ...
    public enum Type {
        NUMBER, FLOAT, INTEGER, BOOLEAN, MODE,
    }
}
